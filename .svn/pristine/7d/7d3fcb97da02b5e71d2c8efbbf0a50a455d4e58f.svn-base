...
<!--                                <input class="btn_cjfw" value="请选择"  type="button" onclick="get_depart_all()">-->
                            ...
                            <td colspan="2">
                                <table class="biaozhun03" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <input class="Wdate bzsr" name="c_time_start[]" value="" id="d4321" onfocus="WdatePicker({dateFmt:'MM月dd日'})" style="width:80px; text-align:center; float: left; " type="text">
                                            <label class="sizi" style="width:10px; text-align:center;padding:0px;" >-</label>
                                        <input class="Wdate bzsr" name="c_time_end[]" value="" id="d4321" onfocus="WdatePicker({dateFmt:'MM月dd日'})" style="width:80px; text-align:center; float: left; " type="text">
                                        <input class="bzsr11" name="c_plan_more[]" type="text" style="width:70%; float: left;">
                                            ...
                                            <input type="hidden" value="0" name="tr_hidden[]">
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="canyu_id" value="">
