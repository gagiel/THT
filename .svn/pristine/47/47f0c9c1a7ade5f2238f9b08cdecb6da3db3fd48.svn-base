...
class remind_r extends CI_Controller {
    ...
    public function index($page='1',$pageSize='20')
    {
        ...
        //查询结果
        //---------分页------------
        $num = $this->m_remind_copy->remind_num($where);
        ...
        $config['base_url'] = '/index.php/remind_r/index/';
        ...
        $list = $this->m_remind_copy->remind_list($where,($page-1)*$pageSize,$pageSize);
        $data['list'] = $list;

        //---------阅读状态-----------
        $read_state = $this->m_remind_copy->get_read_by_userid($where['userid']);
        ...
        $this->load->view('remind_r/index',$data);
    ...
    public function add()
    {
        ...
        if($this->m_remind_copy->remind_insert($data))
        {
            echo 'success';
        }
        else
    ...
    public function update()
    {
        ...
        if($this->m_remind_copy->remind_update($id,$data))
        {
            echo 'success';
        }
        else
    ...
    public function delete()
    {
        ...
        $id = $this->input->post('id');
        if($this->m_remind_copy->remind_delete($id,array('del'=>'1')))
        {
            echo 'success';
        }
    }
    ...
    public function reader()
    {
        ...
        $list = $this->m_remind_copy->remind_reader($this->input->post('id'));
    ...
    public function get_my_remind()
    {
        ...
        $read = $this->m_remind_copy->get_read_by_userid($userid);
        $html = "";
        if(is_array($list))
        {
            foreach($list as $v)
    ...
    {
        $list = $this->m_remind_copy->get_remind_by_userid('-1');
    }
    ...
    public function read()
    {
        ...
        if($this->m_remind_copy->remind_read($data))
        {
            echo 'success';
        }
    }
