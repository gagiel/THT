       ...
       <tr>
		    ...
		    <table cellspacing="0" cellpadding="0" class="biaozhun2">
              ...
              if(!empty($credit)){
              	...
              	?>
              	 <tr>
	                <td>
	                     <input type="text" class="bzsr" name="business_name[]"  value="<?=$value['business_name']?>"  />
	                </td>
                   <td>
	               		<textarea name="business_explain[]" style="width:80%;"><?=$value['business_explain']?></textarea>
	               </td>
     				<td>
	               	 	<input type="text" class="bzsr" name="mark[]" value="<?=$value['mark']?>" />
	               </td>
	               </tr>
	               <?php 
              	}
        ...
        <tr>
          ...
          <td width="92%" colspan="3" class="cknr2">
            <input type="text" class="bzsr" name="contact" value="<?=$contact?>" />
          </td>
        </tr>
         <?php 
         $tel = explode(',',$tel);
         ...
         <tr>
          ...
          <td width="92%" colspan="3" class="cknr2">
               <input type="text" class="bzsr" name="tel[]" value="<?=$v?>" />
        ...
        <tr><td colspan="4" style="height:0px;"></td></tr>
         ...
         <tr>
          ...
          <td width="92%" colspan="3" class="cknr2">
               <input type="text" class="bzsr" name="mobile[]" value="<?=$v?>" />
        ...
        <tr>
          ...
          <td width="92%" colspan="3" class="cknr2">
              <input type="text" class="bzsr" name="b_mark" value="<?=$mark?>" />
          </td> 
        </tr>
      </table>
    </div>
...
function checksubmit(){
	...
	var id         = $('[name="id"]').val();
	var thispage   = $('[name="thispage"]').val();
	if(name==''){
		alert('请填写银行名称');
		return false;
	}
	...
	$.post(
		...
		function (data) //回传函数
		{
			...
			if(data=='操作成功')
			{
				...
				location.href="/index.php/bank/view/"+id+"/"+thispage;
			}
		}
	);
}
