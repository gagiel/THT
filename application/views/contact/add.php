...
<input type="file" class="file" id="i_file" name="i_file" onchange="this.form.submit();" style="position:absolute; filter:alpha(opacity:0);opacity: 0; width:1px;" />
  ...
  <form enctype="multipart/form-data" accept-charset="utf-8" method="post" action="/index.php/contact/save/add" id="sub_form" name="sub_form">
    <div class="caozuo4" >
      ...
      <table cellpadding="0" cellspacing="0" class="biaozhun">
		    ...
		    <table cellspacing="0" cellpadding="0" class="biaozhun2">
              ...
              <tr>
                ...
                <td style=" position: relative;">
				  <input type="text" id="company_name_1" name="companyname[]" class="bzsr companyname" autocomplete="off"  onkeyup="company_input(event,this.value,1);"<?/* onblur="get_cinfo(1)"*/?> />
				  <input type="hidden" value="" id="company_id_1" name="companyid[]">
				  <div id="company_sel_1" style ="  position: absolute; top: 32px; left: 99px; width:250px; background: #fff; border:solid 1px #aaa; display:none; text-align:left;z-index: 1; "></div>
                </td>
				  <td id="td_company_url_1">
					  <p id="company_curl_1">-</p>
					  <input type="hidden" id="company_url_1" name="url[]" value=""/>
				  </td>
				  <td id="td_company_postcode_1">
					  <p id="company_cpostcode_1">-</p>
					  <input type="hidden"  id="company_postcode_1" name="postcode[]" value=""/>
				  </td>
                <td>
                  <input type="text" class="bzsr" id="position_1" name="position[]"/>
                </td>
                <td id="td_company_settle_1">
                    <p id="company_sname_1">-</p>
                    <input type="hidden" id="company_settle_1" name="settle[]" value=""/>
                </td>
                <td></td>
              </tr>
              <tr id="last_company">
        ...
        <tr>
          ...
          <td width="92%" class="cknr2">
              <input type="text" class="bzsr" name="fax[]" id="fax" />
        ...
        <tr>
          ...
          <td width="92%" colspan="3" class="cknr2">
              <input type="text" class="bzsr" name="email[]" id="email"/>
		    ...
		    <table width="100%" cellspacing="0" cellpadding="0">
		      <tr>
		        ...
		        <td width="300" class="mor_pic" style="padding-left:10px;">
		          ...
		          <p class="hmyjjh" ><img src="/images/logo_03.jpg" id="reverse_img" style=" margin-left:0px;" onclick="$('#reverse_img').attr('src',$('#reverse').val())"/></p>
		        </td>
		        <td align="left" valign="top" style="text-align:left;padding-left:10px;">
		          <span style="float:left;line-height: 35px;">*图片尺寸：300*200PX</span>
		          <br /><br />
...
$(document).ready(function(){
	...
	$("#add_company").click(function(){
		...
		var tr = '<tr>'
			   ...
			   +     '<div id="company_sel_' + i + '" style ="position: absolute; top: 32px; left: 97px; width:250px; background: #fff; text-align:left; border:solid 1px #aaa; display:none;"></div>'
			   +   '</td>'
	...
	$.post(
		...
		function (data) //回传函数
		{
			if(data == 0){
				...
				var obj = eval('('+data+')');
				$('#td_company_type_'+i).html(obj.typename+"<input type='hidden' id='company_type_"+i+"' name='typeid[]' value='"+obj.typeid+"'/>");
                ...
                $('#td_company_settle_'+i).html(obj.settlename+"<input type='hidden' id='company_settle_"+i+"' name='settle[]' value='"+obj.settle+"'/>");
			}
